...
def process_sales(sales):
    ...
    print("До 1000 р включительно:           Количество продаж = " + str(cnt1) + " Cредний чек = " + "{:.2f}".format(avg1) + " р") 
    print("От 1000 р до 3000 р включительно: Количество продаж = " + str(cnt2) + " Cредний чек = " + "{:.2f}".format(avg2) + " р")
    print("От 3000 р до 5000 р включительно: Количество продаж = " + str(cnt3) + " Cредний чек = " + "{:.2f}".format(avg3) + " р")
    print("Выше 5000 р:                      Количество продаж = " + str(cnt4) + " Cредний чек = " + "{:.2f}".format(avg4) + " р")
    print("")
    print ("Готово!")
